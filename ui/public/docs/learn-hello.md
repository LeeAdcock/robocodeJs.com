...
Think of it like a recipe. A recipe is a list of steps in order, and if you follow them
you get a cake. Code is a recipe for your robot.
...
The semicolon `;` at the end marks the end of the instruction, like a period ends a
sentence.
