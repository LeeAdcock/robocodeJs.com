...
That's the skeleton. Everything fancy is a variation on it. A stationary sniper skips the
last line. A dodger spends most of its energy on the last line and barely aims. A team bot
inserts a "tell my squad what I saw" step after the scan. But the bones are always
sense → aim → fire → move, and they map straight onto radar, turret, gun, body.

The reason to think in these four beats rather than one big blob of code is that each part
