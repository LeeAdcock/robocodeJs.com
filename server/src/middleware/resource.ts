...
export const scopedUser = (req): User => (req as UserScopedRequest).targetUser;
export const scopedApp = (req): TankApp => (req as AppScopedRequest).targetApp;
...
export const loadApp = async (req, res, next) => {
